           ...
           <div class="conlist">
                <div class="search_result">
                	...
                	<c:forEach items="${category.articles }" var="a">
                    	<div class="art_box">
                        	<div class="art_img"><a href="toContent.action?id=${a.id }"><img src="theme/1/images/front/doc.png"></a></div>
                            <div class="art_txt">
                                ...
                                <div class="tag_txt">
                                	<span>发布单位：${a.author }</span>
                                	<span class="pl30">发布时间：${a.publisurDate }</span>
                                </div>
                            </div>
                        </div>
                     </c:forEach>
